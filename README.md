...
React 19 · Vite · Redux Toolkit · React Router · Axios · React Hook Form · Recharts · Lucide React · JSON Server · CSS

🎯 Project Goal

MediConnect aims to simplify healthcare appointment management by bringing patients, doctors, and administrators together in one centralized platform, providing an efficient and seamless healthcare booking experience.
